        ...
        with transaction.atomic():
            ...
            DumpHelper().dump_to_csv_file(
                ...
                all_fields=(
                    ...
                    'housing_status', 'homeless_at_least_one_year', 'homeless_in_three_years', 'homeless_months_in_three_years', 'homeless_months_prior', 'status_documented', 'prior_residence', 'prior_residence_other', 'length_at_prior_residence',
